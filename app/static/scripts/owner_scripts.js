var barColors = ["#00aba9", "#2b5797", "#b91d47", "#472183", "#27374D", "#116A7B"];
        ...
        fetch(`http://localhost:5000/vehicles/${vehicle_id}/payments`)
          ...
          .then((payments) => {
            ...
            for (const payment of payments) {
              ...
              document.querySelector('.payment_record table').appendChild(record);
            ...
            if (vehicles.indexOf(vehicle) === vehicles.length - 1 && hasPayments) {
